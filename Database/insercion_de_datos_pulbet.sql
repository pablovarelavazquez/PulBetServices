...
('GANADOR'),
('DOBLE OPORTUNIDAD'),
('GANADOR (DOS OPCIONES)');

/*RESULTADO*/
INSERT INTO RESULTADO(NOMBRE,ID_TIPO_RESULTADO) VALUES 
('LOCAL',1),
('VISITANTE',1),
('EMPATE',1),
('1 o X',2),
...
/*APUESTA*/
INSERT INTO APUESTA(IMPORTE, ID_USUARIO, FECHA) VALUES 
(1.0, 2, "2018-11-26 12:14:15"),
(2.0, 1, "2018-11-23 12:14:15"),
(1.0, 3, "2018-12-06 17:14:15"),
(1.0, 5, "2018-12-03 10:02:15"),
(5.0, 6, "2018-12-01 17:14:16"),
(1.0, 7, "2018-12-02 10:14:36"),
(3.0, 8, "2018-12-03 17:14:15"),
(1.0, 9, "2018-12-01 13:02:58"),
(4.0, 10, "2018-12-03 17:14:15"),
(1.0, 4, "2018-12-02 15:14:15");
...
/*DIRECCION*/
/*PISO*/
INSERT INTO DIRECCION(ID_USUARIO,CIUDAD,ID_PROVINCIA,CALLE,NUMERO,COD_POSTAL,PISO,LETRA) VALUES 
(1,'Chantada',27,'Carlos Otero Diaz',13,27500,3,'J'),
(5,'Chantada',32,'Carlos Otero Diaz',13,27500,3,'J'),
(8,'Chantada',27,'Carlos Otero Diaz',1,27500,1,'A'),
(9,'Chantada',27,'Juan XXVIII',45,27500,3,'B'),
(10,'Chantada',27,'Rua da Barxela',13,27500,2,'C'),
(2,'Escairon',27,'Rua Chantada',8,27540,1,'A');
/*CASA*/
INSERT INTO DIRECCION(ID_USUARIO,CIUDAD,ID_PROVINCIA,CALLE,NUMERO,COD_POSTAL) VALUES
(4,'Taboada',27,'Casa do Iago',44,27550),
(6,'Chantada',27,'Basan Pequeno',33,27500),
(7,'O Saviñao',27,'Outeiro, Diomondi',13,27540),
(3,'Valga',36,'Casa do Güimil',20,36640);
